                            ...
                            <div class="box-body no-padding">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a style="width: 40px; height: 38px;" href="{{url('az/cp/apis/'.$shop->id.'/edit')}}" class="btn btn-success btn-xs purple">
                                                <i style="font-size: 17px;padding-top: 5px;" class="far fa-edit"></i>
                                            </a>
                                            {{ Form::open(array('url' => App::getLocale()."/cp/apis/". $shop->id,'style' => 'display:inline')) }}
