...
@endsection
@section('breadcrumb')
    <h4>XƏBƏR ƏLAVƏ ET</h4>
    <ol class="breadcrumb">
        <li><a href="/cp"><i class="fa fa-home"></i>Ana səhifə</a></li>
        <li><a href="/cp/news"><i class="fa fa-home"></i>Xəbərlər</a></li>
        ...
        <div class="container">
            <div class="card add-news">
                <div class="card-body b-b">
                    ...
                    @endif
                    <h4>Xəbərlər</h4>
                    <form method="POST"  action="/{{App::getLocale()}}/cp/news{{!is_null($data)?"/".$id:""}}" enctype="multipart/form-data">
                        @csrf
                        @if(!is_null($data))
                            @method('PUT')
                        @else
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="w3-tab1" role="tabpanel" aria-labelledby="w3-tab1">
                                            <div class="table-responsive">
                                                <div class="form-group">
                                                    <label class="checkbox-inline"><input name="homepage" {{ !is_null($data) && $data->homepage == 1 ? 'checked' : null }} type="checkbox" value="1">Ana səhifə</label>
                                        ...
                                        <div class="tab-pane fade" id="w3-tab2" role="tabpanel" aria-labelledby="w3-tab2">
                                            <div class="table-responsive">
                                                ...
                                                <div class="form-group">
                                                    <label for="shopUrl" class="col-form-label">Xəbər</label>
                                                    <textarea class="ckeditor" id="ckeditor2" name="content[ru]">{{!is_null($data) && isset($data->translates[1]->content) ? $data->translates[1]->content : ''}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="w3-tab3" role="tabpanel" aria-labelledby="w3-tab3">
                                            <div class="table-responsive">
                                                <div class="form-group">
                                                    <label for="shopName" class="col-form-label">Başlıq</label>
                                                    <input name="name[en]" type="text" class="form-control" id="shopName" value="{{!is_null($data) && isset($data->translates[2]->name) ? $data->translates[2]->name : ''}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="shopName" class="col-form-label">Qısa başlıq</label>
                                                    <input name="description[en]" type="text" class="form-control" id="shopName" value="{{!is_null($data) && isset($data->translates[2]->description) ? $data->translates[2]->description : ''}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="shopName" class="col-form-label">Açar sözlər</label>
                                                    <input name="keywords[en]" type="text" class="form-control" id="shopName" value="{{!is_null($data) && isset($data->translates[2]->keywords) ? $data->translates[2]->keywords : ''}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="shopUrl" class="col-form-label">Xəbər</label>
                                                    <textarea class="ckeditor" id="ckeditor3" name="content[en]">{{!is_null($data) && isset($data->translates[2]->content) ? $data->translates[2]->content : ''}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
