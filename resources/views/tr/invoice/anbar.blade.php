                ...
                <div class="row">
                    ...
                    <div class="col-md-10 text-center middle content">
                        <form class="formSearch">
                            <div class="row">
                                <div class="col-md-3">
                                    <p class="badge" style="padding: 5px 10px;margin: 11px 0 0;display:show">
                                        Toplam Say: {{$allData->total_count}}
                                    </p>
                                    <p class="badge" style="padding: 5px 10px;margin: 11px 0 0;display:show">
                                        Toplam ağırlık: {{$allData->all_weight}}
                                    </p>
                                </div>
                                <div class="col-md-4">
            ...
            <div class="">
                <div class="buttons_list content">
                    <ul class="buttons_list">
                        ...
                        <li><a id="anbar" data-status="2" href="{{url('/invoices/get/anbar')}}" class="btn-effect {{$status==2 ? 'active' : ''}} ">ANBAR</a></li>
                        <li><a id="anbar" data-status="4" href="{{url('/invoices/get/faturalar')}}" class="btn-effect {{$status==4 ? 'active' : ''}} ">Faturalar</a></li>
        ...
        <div class="custom-container">
            ...
            <div class="right_buttons_container" >
                <ul class="right_buttons">
                    ...
                    <li style="display:{{$display}}">
                        <form action="{{url('invoices/addFatura')}}" method="post" id="selected_inputs_fatura" class="form-inline">
                            <div class="form-group">
                                <select class="form-control" name="fatura_id" id="fatura_id">
                                    <option value="0">Yeni fatura</option>
                                    <option value="-1">Sıvılar</option>
                                    @php($count_i=1)
                                    @foreach($faturalar as $fatura)
                                        <option value="{{$fatura->id}}">Fatura {{$count_i}} ({{$fatura->total_weight}} kq)</option>
                                        @php($count_i++)
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <input value="Faturaya ekle" type="submit" class="btn-effect orange_inner" >
                            </div>
                        </form>
                    </li>
