<div style="border: 1px solid #000; padding: 10px;border-radius: 6px;">
    ...
    <div style="border: 1px solid #000;padding: 0 10px 10px; border-radius: 4px;">
        <p style="font-weight: bold; margin-bottom: 0; font-size: 11px; line-height: 12px;">{{$product->relUserProducts->users->name}} {{$product->relUserProducts->users->surname}} - {{$product->relUserProducts->users->uniqid}}</p>
        <dl style="margin-bottom: 0;">
            <div style="margin-bottom: 0;">
                <dt style="float: left; font-weight: bold; font-size: 10px;width: 8%;">Mobil:</dt>
                <dd style="float: left; font-size: 10px; text-align: left; margin-bottom: 0;">{{$product->relUserProducts->users->userContacts[0]->name}}</dd>
                <br clear="all">
            </div>
            <div style="margin-bottom: 0;">
                <dt style="float: left; font-size: 10px; font-weight: bold; width: 8%;">Address:</dt>
                <dd style="float: left; font-size: 10px; text-align: left; margin-bottom: 0;">{{$product->relUserProducts->users->address}}</dd>
                <br clear="all">
            </div>
            <div style="margin-bottom: 0;">
    ...
    <p style="font-weight: bold;text-align: center; margin-bottom: 0; font-size: 11px; line-height: 10px;">www.limak.az | info@limak.az | *9595</p>
</div>