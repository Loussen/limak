                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="w3-tab1" role="tabpanel" aria-labelledby="w3-tab1">
                                <div class="table-responsive">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea required rows="5" id="summernote answer-az" class="form-control r-0" name="answer[az]">{{!is_null($data) ? $data->translates[0]->answer : ''}}</textarea>
                                    </div>
                                </div>
                            </div>
                            {{--<div class="tab-pane fade" id="w3-tab2" role="tabpanel" aria-labelledby="w3-tab2">
                                <div class="table-responsive">
                                    <div class="form-group">
                                        <label for="shopName" class="col-form-label">Sual</label>
                                        <input required name="question[ru]" type="text" class="form-control" id="question-ru" value="{{!is_null($data) ? $data->translates[1]->question : ''}}" placeholder="Sifarişinizi rahat şəkildə edin">
                                    </div>
                                    <div class="form-group">
                                        <label for="shopUrl" class="col-form-label">Cavab</label>
                                        <textarea required rows="5" id="summernote answer-ru" class="form-control r-0" name="answer[ru]">{{!is_null($data) ? $data->translates[1]->answer : ''}}</textarea>
                                    </div>
                                </div>
                            </div>--}}
                        </div>
