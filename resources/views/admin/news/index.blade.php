...
@section('content')
    <div class="content-wrapper animatedParent animateOnce">
        <div style="width: 100%;" class="container">
            <a class="btn btn-primary" style="margin-bottom: 20px;" href="{{route('news.create')}}">Xəbər əlavə et</a>
            <section class="paper-card">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title"><strong>Xəbərlər</strong></h3>
                                <br>
                            ...
                            <div class="box-body no-padding">
                                    ...
                                    <table class="table table-striped">
                                        <tbody>
                                        <form id="searchForm" action="{{route('news.index')}}" method="get">
                                            <tr>
                                                <th >#</th>
                                                <th >id</th>
                                                <th>Xəbərin adı</th>
                                        ...
                                        @foreach($data as $key => $value)
                                            <tr>
                                                ...
                                                <td style="min-width: 200px;">
                                                    <a style="width: 40px; height: 38px;" href="{{url('az/admin/news/'.$value->id.'/edit')}}" class="btn btn-success btn-xs purple">
                                                        <i style="font-size: 17px;padding-top: 5px;" class="far fa-edit"></i>
                                                    </a>
                                                    {{ Form::open(array('url' => App::getLocale()."/admin/news/". $value->id,'style' => 'display:inline')) }}
