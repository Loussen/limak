...
@section('content')
    <div class="content-wrapper animatedParent animateOnce">
        <div style="width: 100%;" class="container">
            <a class="btn btn-primary" style="margin-bottom: 20px;" href="{{route('shops.create')}}">Mağaza əlavə et</a>
            <a class="btn btn-primary" style="margin-bottom: 20px;" href="{{route('shop-types.index')}}">Tiplər</a>
                            ...
                            <div class="box-body no-padding">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a style="width: 40px; height: 38px;" href="{{url('az/admin/shops/'.$shop->id.'/edit')}}" class="btn btn-success btn-xs purple">
                                                <i style="font-size: 17px;padding-top: 5px;" class="far fa-edit"></i>
                                            </a>
                                            {{ Form::open(array('url' => App::getLocale()."/admin/shops/". $shop->id,'style' => 'display:inline')) }}
