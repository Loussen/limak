                        ...
                        <div class="col-xs-6">
                            <div class="input-group">
                                <select class="form-control selectpicker"  id="region" title="Region">
                                    ...
                                    <option value="4">@lang('panel-errors.zagatala')</option>
                                    <option value="5">@lang('panel-errors.lankaran')</option>
                                    {{--<option value="rusiya">Rusiya</option>--}}
                                    {{--<option value="azerbaycan">Azərbaycan</option>--}}
                                </select>
                            </div>
                            ...
                            <div class="block col-sm-12 col-xs-12">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <ul class="nav nav-tabs country-inner-tabs" role="tablist">
                                        ...
                                        <li role="presentation">
                                            <a href="#usa-zagatala" aria-controls="turkey-zagatala" role="tab" data-toggle="tab">
                                                @lang('home.usa-zagatala')
                                            </a>
                                        </li>
                                        <li role="presentation">
                                            <a href="#usa-lankaran" aria-controls="turkey-lankaran" role="tab" data-toggle="tab">
...
--}}
                    <a href="{{url(app()->getLocale() . '/blog/'.$item->id)}}">
