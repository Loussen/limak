                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-12">
                                            ...
                                            <ul class="nav nav-tabs country-inner-tabs" role="tablist">
                                                ...
                                                <li role="presentation">
                                                    <a href="#turkey-zagatala" aria-controls="turkey-zagatala" role="tab" data-toggle="tab">
                                                        @lang('home.turkey-zagatala')
                                                    </a>
                                                </li>
                                                <li role="presentation">
                                                    <a href="#turkey-lankaran" aria-controls="turkey-lankaran" role="tab" data-toggle="tab">
                                                        @lang('home.turkey-lankaran')
                                                    </a>
                                                </li>
                                                <li role="presentation">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="turkey-zagatala">
                                                    <ul>
                                                        @lang('home.tr-zagatala-tariffs')
                                                    </ul>
                                                </div>
                                                <div role="tabpanel" class="tab-pane fade" id="turkey-lankaran">
                                                    <ul>
                                                        @lang('home.tr-lankaran-tariffs')
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="bottom-text">
                                                <b>@lang('home.liquid-products')</b>
                                                <div>
                                                    <ul>
                                                        @lang('home.tr-liquid-tariffs')
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="bottom-text">
                                ...
                                <div class="countries-content block">
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-12">
                                            ...
                                            <ul class="nav nav-tabs country-inner-tabs" role="tablist">
                                                <li role="presentation" class="active">
                                                    <a href="#usa" aria-controls="usa" role="tab" data-toggle="tab">
                                                        @lang('home.usa-baku')
                                                    </a>
                                                </li>
                                                <li role="presentation">
                                                    <a href="#usa-ganja" aria-controls="usa-ganja" role="tab" data-toggle="tab">
                                                        @lang('home.usa-ganja')
                                                    </a>
                                                </li>
                                                <li role="presentation">
                                                    <a href="#usa-sumgait" aria-controls="usa-sumgait" role="tab" data-toggle="tab">
                                                        @lang('home.usa-sumgait')
                                                    </a>
                                                </li>
                                                <li role="presentation">
                                                    <a href="#usa-zagatala" aria-controls="usa-zagatala" role="tab" data-toggle="tab">
                                                        @lang('home.usa-zagatala')
                                                    </a>
                                                </li>
                                                <li role="presentation">
                                                    <a href="#usa-lankaran" aria-controls="usa-lankaran" role="tab" data-toggle="tab">
                                                        @lang('home.usa-lankaran')
                                                    </a>
                                                </li>
                                                <li role="presentation">
                                                    <span>@lang('home.have-more')</span>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="usa-zagatala">
                                                    <ul>
                                                        @lang('home.usa-zagatala-tariffs')
                                                    </ul>
                                                </div>
                                                <div role="tabpanel" class="tab-pane fade" id="usa-lankaran">
                                                    <ul>
                                                        @lang('home.usa-lankaran-tariffs')
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="bottom-text">
