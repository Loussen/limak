            ...
            <div class="">
                <div class="buttons_list content">
                    <ul class="buttons_list">
                        ...
                        <li><a id="foreign" data-status="1" class="btn-effect active">Packages</a></li>
                        <li><a id="depo_packages" data-status="1" class="btn-effect" href="{{url('/depo_packages')}}">Depo Packages</a></li>
                            ...
                            @foreach($data as $value)
                                <tr class="tr_{{$value->id}}">
                                    ...
                                    <td class="align-middle">
                                        ...
                                        ?>
                                        <button type="button" class="btn btn-success" id="edit-item" data-item-id="{{$value->parcel_id}}">edit</button>
                                    </td>
                                </tr>
                            @endforeach
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Change Value & Description</h4>
                </div>
