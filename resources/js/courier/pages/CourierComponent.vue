    ...
    <div>
        ...
        <div class="content-wrapper animatedParent animateOnce">
            <div style="width: 100%;" class="container">
                <router-link style="margin-bottom: 20px;" class="btn btn-primary" to="/waiting">
                    Göndərilmiş kuryerlər
                </router-link>
                        ...
                        <div class="col-lg-12">
                            <div class="box text-left">
                                <div class="box-header">
                                    <h3 class="box-title text-center"><strong>Daxil olan kuryer sifarişləri</strong></h3>
                                    <br>
                                </div>
                                <div class="box-body no-padding">
                                    ...
                                    <table class="table dtr-details" width="100%" v-if="data != null && data.length !== 0">
                                        ...
                                        <tr v-for="order of data">
                                            ...
                                            <td><button v-on:click="addCourier(order.id)" class="btn btn-warning">Kuryer təyin edildi</button></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getCourierOrders() {
                axios.get('/admin/courier/orders-waiting')
                    .then(data => {
