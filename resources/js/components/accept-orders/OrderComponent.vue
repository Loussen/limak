<template>
    <div class="content-wrapper animatedParent animateOnce">
        <div style="width: 100%;" class="container">
                            ...
                            <div class="box-header">
                                ...
                                <div v-if="data !== null" class="user-data">
                                    <div class="calc-additional-price ">
                                        <button class="btn btn-info">Balans {{data.balance}}</button> <Br />
                                    ...
                                    <div class="user-data-email" v-if="data.user_contacts">
                                        <label> Nömrələr: </label>
                                        <h4>
                                            <span style="display: block; margin-bottom: 10px;" v-for="userContact of data.user_contacts">
                                                {{userContact.name}}
                                            </span>
                                        </h4>
                                    </div>
                                    <div class="user-data-email" v-if="data.user_contacts">
                                        ...
                                        <h4>
                                            Halkalı Merkez Mahellesi. Üzümlü SK. 5/7 kod: {{data.uniqid}} {{data.name}} {{data.surname}} <button style="margin-left: 10px;" class="btn btn-xs btn-primary" @click.stop.prevent="copyTestingCode">Kopyala</button>
                                            <input type="hidden" id="copy" :value="'Halkalı Merkez Mahellesi. Üzümlü SK. 5/7 kod: ' + data.uniqid + ' ' + data.name + ' ' + data.surname">
                                        </h4>
                                    </div>
                                </div>
                            </div>
         ...
         <!--   <div v-if="data !== null && data.products.statuses.label !== 'completed'" style="margin-top: 20px;" class="text-right">
...
<script>
    ...
    export default {
        ...
        methods: {
            getOrderDetails() {
                axios.get('/admin/orders/detail/by-user/' + this.$route.params.id)
                    .then((data) => {
                        //console.log(data);
                        if(data.data.data) {
