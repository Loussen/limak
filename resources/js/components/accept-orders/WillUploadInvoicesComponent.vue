                    ...
                    <div class="col-lg-12">
                        <div class="box text-left">
                            <div class="box-header">
                                <h3 class="box-title text-center">
                                    <strong>İnvoys yüklənəcəklər</strong>
                                </h3>
                            </div>
                        </div>
                        ...
                        <table class="table dtr-details" width="100%" v-if="data != null && data.length !== 0">
                            ...
                            <tr v-for="transaction of data">
                                ...
                                <td>{{transaction.users.uniqid}}</td>
                                ...
                                <td>{{(transaction.price * 3.32).toFixed(2)}} TL</td>
                                <td>
                                    <router-link v-bind:to="'/invoice-upload/' + transaction.id">
...
<script>
    export default {
        name: "will-upload-invoices-component",
        data() {
            return {
                data: null
            }
        ...
        methods: {
            getOrders() {
                axios.get('/admin/will-upload-invoices/list')
                .then((data) => {
