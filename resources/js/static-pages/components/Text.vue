    ...
    <div>
        ...
        <template v-if="lang === 'az'">
            <div class="form-group">
                ...
                <input type="text" v-model="section.value.az.name" class="form-control" placeholder="...">
            </div>
            <div class="form-group">
                <label><strong>Mətn:</strong></label>
                <vue-ckeditor
                        v-model="section.value.az.description"
                        :config="config"/>
            </div>
        </template>
        <template v-if="lang === 'ru'">
            <div class="form-group">
                <label><strong>Başlıq:</strong></label>
                <input type="text" v-model="section.value.ru.name" class="form-control" placeholder="...">
            </div>
            <div class="form-group">
                <label><strong>Mətn:</strong></label>
                <vue-ckeditor
                        v-model="section.value.ru.description"
                        :config="config"/>
            </div>
        </template>
