        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="block">
                            ...
                            <div class="center-block col-md-8 col-sm-8 col-xs-12">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <span v-if="commonData.extras!=null">{{commonData.extras.size}}</span>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="pay">
                        <button type="button" class="btn-effect" @click="payPrice">Ödəniş et</button>
                                    ...
                                    <div class="input-group border-radius">
                                        <label>
                                            <input type="text" name="size" class="form-control inputText"
                                                   v-model="basket.size" placeholder=" ">
                                            <span>Ölçü</span>
                                        </label>
                                    </div>
                                    <div class="modal-button text-right">
                                        <button data-dismiss="modal" @click="sendEditedBasket()" class="btn-effect">Yadda saxla</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        methods: {
            payPrice(){
                ...
                if(this.allPrices>0){
                    ...
                    swal({
                        ...
                        onOpen: () => {
                            swal.showLoading();
                            axios.post('/user-panel/pay-basket-price',{price:this.allPrices, products:this.checkedBoxes })
                                .then(response=>{
                                    swal.close();
            ...
            changePrice(shPrice,i_id){
                if(event.target.checked) {
                    this.allPrices = parseFloat(this.allPrices,2)+parseFloat(shPrice, 2);
                    ...
                    if(this.allOrders[i].price !== null){
                        ...
                        if (this.allOrders[i].checked === true) {
                            if(!this.checkedBoxes.includes(this.allOrders[i].id)) {
                                this.allPrices =parseFloat(this.allPrices,2) + parseFloat(this.allOrders[i].price, 2);
