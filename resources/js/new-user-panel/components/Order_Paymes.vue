                            ...
                            <div class="order-left-side block">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active">
                                        <a href="#1" aria-controls="home" role="tab" data-toggle="tab" class="order-img1">Türkiyə`dən</a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="input-group">
                                                        <label data-v-170866b4="" class="select-class">Türkiyə içi karqo *</label>
                                                ...
                                                <div class="col-sm-3 col-xs-6">
                                                    <label class="select-class" v-if="order.hasCargo === 'ode'">Karqo məbləği *</label>
...
-->
                                                ...
                                                <div class="col-sm-3  col-xs-6">
                                                    <div class="input-group border-radius">
                                                        <label>
                                                            <label data-v-170866b4="" class="select-class">Cəmi(+5%)</label>
                        ...
                        <div class="changeable col-md-3 col-sm-4 col-xs-12">
                            ...
                            <div class="right-bottom ">
                                ...
                                <label class="radio-button">
                                    <span class="exp">Normal sifariş </span> <br>
                                    <span class="description">( Gün ərzində pulsuzdur )</span>
                                    <input type="radio" v-model="deliveryType" value="0" checked="checked" name="radio"  @click="deliveryTypeStatus('standart')">
                                    <span class="checkmark"></span>
                                </label>
                                <label class="radio-button">
                                    <span class="exp">Təcili sifariş </span> <br>
                                    <span class="description">( 1 saat ərzində +2$ )</span>
                                    <input type="radio" v-model="deliveryType" value="1" name="radio" @click="deliveryTypeStatus('express')">
                                    <span class="checkmark"></span>
                                </label>
                                <div class="sum">
                                    <span>Cəmi: </span>
                                ...
                                <div class="text-center">
                                    <button class="btn-send btn-effect"  :disabled="!policy" @click="submit()">Göndər</button>
                                    <p class="almark">Bu bir Almark xidmətidir.</p>
                                </div>
            ...
            submit() {
                ...
                this.orders.forEach((order, index) => {
                    ...
                    if (!order.hasCargo || !order.link || (!order.price || order.price === '') || (!order.quantity || order.quantity === 0)) {
                        valid = false;
                        swal({
                            title: `${count} nömrəli sifarişdə "*" (ulduz)- ilə işarələnmiş sahələrin doldurulması zəruridir`,
                            type: "error"
                        });
                    ...
                    if (order.hasCargo === 'ode' && (!order.cargo || order.cargo == 0)) {
                        valid = false;
                        swal({
                            title: `${count} nömrəli sifarişdə Ölkədaxili cargo ödənişli seçilməyinə baxmayaraq cargo qiyməti qeyd edilməmişdir!`,
                            type: "error"
                        });
                ...
                if (valid) {
                    ...
                    swal({
                        ...
                        onOpen: () => {
                            swal.showLoading();
                            axios({url: api.orderLinkInsert2, method: 'POST', data: {data: this.orders,promo_code: this.promo, ytl: ytlPayment, total: this.exchange, deliveryType: this.deliveryType, country: this.country}})
                                .then(response => {
                                    swal.close();
                                    this.modalTogglePayment = true;
                                    //window.location.href = '/az/user-panel#/payment/'+response.data.id
                                    this.$router.push('/payment/'+response.data);
                                });
                        }
                    })
                } else {
                    ...
                    if (this.attempts > 3) {
                        swal({
                            title: 'Əgər sifariş edərkən çətinlik çəkirsinizsə Online chat vasitəsi ilə kömək ala bilərsiniz!',
                            type: "info",
