<template>
    <section class="order spin-load content num-spin fixed-class">
            ...
            <div class="row">
                <div class="order-head col-xs-12">
                    <div class="col-md-4 col-sm-5 col-xs-6">
                        <h4>{{ExWindow ? ExWindow.translator('panel-errors.order2') : '' }} <b>{{ExWindow ?
                            ExWindow.translator('panel-errors.do') : '' }}</b></h4>
                    </div>
                    <div class="col-md-8 col-sm-7 col-xs-6 ">
                        <ol class="breadcrumb web">
                            <li><a href="/">{{ExWindow ? ExWindow.translator('panel.home_page') : '' }} </a></li>
                            <li><a href="/site/user-panel"> {{ExWindow ? ExWindow.translator('panel.user_panel') : ''
                                }} </a></li>
                            ...
                            <div class="order-left-side block">
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="1">
                                        <div class="left-content customer-select">
                                            ...
                                            <div class="row">
                                                <div class="col-md-9 col-sm-9 col-xs-6">
                                                    <div class="input-group border-radius">
                                                        <label>
                                                            <input type="text" v-model="order.link" @blur="parse(index)"
                                                    ...
                                                    <div class="input-group border-radius">
                                                        <label>
                                                            <input type="text" v-model="order.price"
                                                                   @input="singleTotal(index)"
                                                                   @change="singleTotal(index)"
                                                                   class="form-control inputText" placeholder=" ">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="input-group">
                                                        <label data-v-170866b4="" class="select-class">{{ExWindow ?
                                                            ExWindow.translator('link-order.cargoTR') : '' }} *</label>
                                                        <v-select placeholder="getPlaceHolder"
                                                                  v-model="order.cargo_type" :options="cargo_types"
                                                                  label="name"
                                                                  v-on:change="change(order,index)"></v-select>
                                                ...
                                                <div class="col-sm-3 col-xs-6">
                                                    <label class="select-class" v-if="order.hasCargo === 'ode'">{{ExWindow
                                                        ? ExWindow.translator('panel-errors.cargo_price') : '' }}
                                                        *</label>
                                                    <input v-if="order.hasCargo === 'ode'" v-model="order.cargo"
                                                           type="number" class="form-control" name="input"
                                                           @input="singleTotal(index)">
                                                    <!--
                                                ...
                                                <div class="col-sm-3  col-xs-6">
                                                    <div class="input-group border-radius">
                                                        <label>
                                                            <label data-v-170866b4="" class="select-class">{{ExWindow ?
                                                                ExWindow.translator('panel-errors.sum') : ''
                                                                }}(+5%)</label>
                                                            <input type="text" v-model="order.total"
                                                                   class="form-control"
                                                                   disabled
                                                    ...
                                                    <div class="input-group number-spinner">
                                                        <span class="input-group-prepend">
                                                            <button class="btn btn-default" type="button" data-dir="dwn"
                                                                    @click="dec(order,index)"><strong>-</strong></button>
                                                        </span>
                                                        <input class="form-control text-center" v-model="order.quantity"
                                                               @input="singleTotal(index)"
                                                               placeholder="Bağlamadakı məhsulun sayı *" type="number"
                                                               value="" min="1"/>
                                                        <span class="input-group-append">
                                                            <button class="btn btn-default" type="button" data-dir="up"
                                                                    @click="inc(order,index)"><strong>+</strong></button>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                    <div class="input-group border-radius">
                                                        <label>
                                                            <input type="text" v-model="order.desc" name="length"
                                                                   class="form-control inputText" placeholder=" ">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="btn-part text-right">
                                                        <button class="btn-linkk btn-effect" v-if="index > 0"
                                                                @click="deleteRow(index)">
                                                            <span>{{ExWindow ? ExWindow.translator('panel-errors.delete-link') : '' }}</span>
                                                        </button>
                                                        <button class="btn-add btn-effect"
                                                                v-if="orders.length - 1 === index" @click="addRow()">
                        ...
                        <div class="changeable fixed-right col-md-3 col-sm-4 col-xs-12">
                            ...
                            <div class="right-bottom ">
                                ...
                                <label class="radio-button">
                                    ...
                                    <span class="description">( {{ExWindow ? ExWindow.translator('panel-errors.balance_payment_desc') : '' }} <br /><b>{{ExWindow ? ExWindow.translator('panel-errors.tl_balance') : '' }}: {{balance_try}}TL</b> )</span>
                                    <input type="radio" v-model="payment_type" value="1" name="radio" @click="paymentTypeStatus('balance')">
                                    <span class="checkmark"></span>
                                </label>

                                <!--<h4 class="text-center">{{ExWindow ? ExWindow.translator('panel-errors.do_order') : ''
                                    }}</h4>
                                <label class="radio-button">
                                    <span class="exp">{{ExWindow ? ExWindow.translator('panel-errors.normal_order') : '' }} </span>
                                    <br>
                                    <span class="description">( {{ExWindow ? ExWindow.translator('panel-errors.free_in_day') : '' }} )</span>
                                    <input type="radio" v-model="deliveryType" value="0" checked="checked" name="radio"
                                           @click="deliveryTypeStatus('standart')">
                                    <span class="checkmark"></span>
                                </label>
                                <label class="radio-button">
                                    <span class="exp">{{ExWindow ? ExWindow.translator('panel-errors.urgent_order') : '' }} </span>
                                    <br>
                                    <span class="description">( {{ExWindow ? ExWindow.translator('panel-errors.in_one_hour') : '' }} +2$ )</span>
                                    <input type="radio" v-model="deliveryType" value="1" name="radio"
                                           @click="deliveryTypeStatus('express')">
                                    <span class="checkmark"></span>
                                </label>-->
                                <div class="sum">
                                    <span>{{ExWindow ? ExWindow.translator('panel-errors.sum') : '' }}: </span>
                                    <span class="cash">{{totalPriceTry}} TL</span>

                                    <label class="check-button">
                                        <span class="check-btn-text" data-toggle="modal" data-target=".privacy-modal"
                                              @click="privacyPolicy">{{lang ? lang('link-order.policy') : ''}}</span>
                                ...
                                <div class="text-center">
                                    <button :class="this.orders[0].price > 0 ? null : 'btn-send'" class="btn-effect"
                                            @click="submit()">{{ExWindow ? ExWindow.translator('panel-errors.pay') : '' }}
                                    </button>
                                    <p class="almark">{{ExWindow ? ExWindow.translator('panel-errors.almark_service') : '' }}</p>
                                </div>

                                <!--<div class="text-center">
                                    <button class="btn-effect" @click="toBasket()">{{ExWindow ?
                                        ExWindow.translator('panel-errors.to_basket') : '' }}
                                    </button>
                                </div>-->
                            </div>
                        </div>
        ...
        <div class="privacy-modal modal fade" :class="{ in: modalShown }" tabindex="-1" role="dialog"
             aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <header class="modal-header">
                        <h5 style="display: inline-block;" class="modal-title"><h3>{{lang ?
                            lang('link-order.distantDeliverytitle') : ''}}</h3></h5>
                    ...
                    <main class="modal-body">
                        <div v-if="lang && lang('link-order.distantDeliveryBody') === 'az'">
                            ...
                            <ul>
                                ...
                                <li>
                                    &mdash; Daşınan bağlamanın çatdırılma üçün xidmət haqqı iki meyar üzrə, çəki və həcmə görə hesablanır. İstifadəçi bu meyarlar üzrə hesablanmış daşınma haqqının daha çox olanı üzrə ödəniş aparmalıdır.
                                </li>
                                <li>
                                    &mdash; Öz şifrə və məlumatları digər şəxslərə verməməlidir. Belə hallar baş
                                    verərsə,
                            ...
                            <ul>
                                ...
                                <li>&mdash; İcraçı sifarişçinin bütün məlumatlarının gizliliyinə və təhlükəsizliyinə
                                    təminat
                                    verir.
                                </li>
                                <li>&mdash; İcraçıya sifarişin alınması və bu xidmətin həyata keçirilməsi üçün müəyyən
                                    olunmuş vəsait tam ödədikdən sonra sifariş icra olunur.
                                </li>
                                <li>&mdash; İcraçının məhsulun tam və vaxtında, sifariş şərtlərinə görə sifariş edilməsi
                                    öhdəliyi var
                                </li>
                                <li>&mdash; İcraçı hər hansı səbəbdən sifarişi yerinə yetirə bilmədikdə sifarişçinin
                                    ödədiyi
                                    məbləği və xidmət haqqını ona geri qaytarır.
                                </li>
                                <li>&mdash; İcraçı sifarişin izlənməsini təmin edir, sifarişin verilməsi ilə bağlı
                                    sifarişçini
                                    mütəmadi məlumatlandırır.
                                </li>
                            </ul>
                        </div>
                        <div v-if="lang && lang('link-order.distantDeliveryBody') === 'ru'">
                            <p>
                                Заказчик, подтверждая данный договор, соглашается с правилами дистанционной продажи
                                компании.
                            ...
                            <ul>
                                <li>
                                    &mdash; Заказчик, пройдя регистрацию в системе, должен указать в требуемом порядке
                                    свои личные данные.
                                </li>
                                <li>
                                    &mdash; Заказчик носит ответственность за достоверность вводимых для регистрации
                                    данных
                                </li>
                                <li>
                                    &mdash; В случае внесения заказчиком каких-либо изменений в данные, он обязан
                                    направить оповещение об обновлении личной информации.
                                </li>
                                <li>
                                    &mdash; Если заказчик после предупреждения продолжит заказывать запрещенные товары,
                                    услуга будет заблокирована для этого заказчика.
                                </li>
                                <li>
                                ...
                                <li>
                                    &mdash; Плата за доставку товара взимается по двум параметрам - весу и объему заказываемого предмета. Заказчику следует оплатить плату по тому параметру, где указана наибольшая сумма.
                                </li>
                                <li>
                                    &mdash; Не следует делиться с другими лицами шифром и данными. В таких случаях
                                    пользователь несет персональную ответственность за задолженность и заказ.
                                </li>
                                <li>
                                    &mdash; Если после оформления заказа производитель не выполняет его адекватно, то
                                    исполнитель не несет ответственность за это.

                                </li>
                                <li>
                                    &mdash; При оформлении заказа следует указывать дополнительную информацию о скидках,
                                    иначе скидки не будут учтены.
                                </li>
                                <li>
                                    &mdash; Если заказчик пользуется услугой "Срочный заказ", за это следует внести
                                    дополнительную плату в соответствии с определенным тарифом.
                                </li>
                                <li>
                                    &mdash; Если заказчик превысит установленный Кабинетом Министров месячный лимит для
                                    беспошлинного ввоза товаров личного пользования, ему потребуется заплатить
                                    дополнительную таможенную пошлину для оформления посылки.
                                </li>
                                <li>
                                    &mdash; Если заказчик ввозит в страну продукцию на сумму, значительно превышающую
                                    установленный Кабинетом Министров месячный лимит, то таможенное оформление груза
                                    проводит он сам, либо его полномочный представитель.
                                </li>
                                <li>
                                    &mdash; Если заказчик после предупреждения системы продолжит заказывать товары с
                                    подозрительных интернет-магазинов, то исполнитель не будет нести ответственность за
                                    возможные риски.

                                </li>
                                <li>
                                    &mdash; Исполнитель не несет ответственность за изъяны в качестве, размере, марке
                                    заказанного товара и др. недостатки производителя.
                                </li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>&mdash; В случае невыполнения исполнителем заказа по какой-либо причине, ему следует
                                    возвратить заказчику уплаченную сумму и плату за услуги.
                                </li>
                                <li>&mdash; Исполнитель обязан своевременно и в полной мере выполнить заказ в
                                    соответствии с условиями заказа.
                                </li>
                                <li>&mdash; Исполнитель обеспечивает отслеживание заказа, регулярно информирует
                                    заказчика об этапах выполнения заказа. Отказ Подтверждение
                                </li>
                            </ul>
                        </div>
                    </main>
                    <footer class="modal-footer">
                        <button class="btn btn-effect" @click="deni()" data-dismiss="modal">{{ExWindow ? ExWindow.translator('panel-errors.accept') : '' }}</button>
                        <button class="btn btn-effect" @click="accept()" data-dismiss="modal">{{ExWindow ? ExWindow.translator('panel-errors.reject') : '' }}</button>
                    </footer>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getPause()
            {
                axios.get("/panel/order-status").then(res => {
                    if(res.data.status===0){
                        this.$router.push("/orderPause")
                    }else{
                       /* var d = new Date();
                        var n = d.getDay();
                        var h = d.getHours();
                        ...
                        if((n == 0 && h>=8) || (n==1 && h<9)){
                            console.log("Pause"+n+h);
                            this.$router.push("/orderPause")
                        }else{
                            console.log("Not Pause"+n+h);
                        }*/
                    }
                });
            ...
            submit() {
                ...
                this.orders.forEach((order, index) => {
                    const count = index + 1;
                    if (!order.hasCargo || !order.link || (!order.price || order.price === '') || (!order.desc || order.desc === '') || (!order.quantity || order.quantity === 0)) {
                        valid = false;
                        swal({
                ...
                if (valid) {
                    ...
                    var ytl = parseFloat(parseFloat(this.totalPriceTry));
                    const ytlPayment = ytl.toFixed(2);
                    swal({
                        ...
                        onOpen: () => {
                            ...
                            if(this.payment_method=='paytr'){
                                axios({url: api.orderLinkInsert, method: 'POST',
                                    data: {
                                        data: this.orders,
                                ...
                                swal.fire({
                                    ...
                                    text: this.ExWindow ? this.ExWindow.translator('panel-errors.payment_from_tl') : '',
                                    type: 'warning',
                                    ...
                                    if (result.value) {
                                        axios({url: api.orderBalanceLinkInsert, method: 'POST',
                                            data: {
                                                data: this.orders,
                                                promo_code: this.promo,
                                                ytl: ytlPayment,
                    ...
                    swal({
                        ...
                        onOpen: () => {
                            ...
                            axios({
                                ...
                                swal.close();
                                swal({
                                    title: this.ExWindow ? this.ExWindow.translator('panel-errors.links_added') : '',
                                    type: "info"
                                });
                            });
                        }
            ...
            singleTotal(index) {
                ...
                if (order.hasCargo && order.hasCargo === 'ode' && order.cargo) {
                    this.orders[index].cargo = this.orders[index].cargo.replace(",", ".");
                    this.orders[index].cargo = this.orders[index].cargo.replace(/[^0-9.]/g, "");

                    price = price + parseFloat(this.orders[index].cargo);// * parseFloat(order.quantity)
                }
            ...
            summarize() {
                ...
                this.totalPriceTry = this.totalPrice;
                this.totalAdder();
            },
            privacyPolicy() {
