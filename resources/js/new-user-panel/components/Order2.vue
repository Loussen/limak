            ...
            <div class="row">
                <div class="order-head col-xs-12">
                    <div class="col-md-4 col-sm-5 col-xs-6">
                        <h4>{{ExWindow ? ExWindow.translator('panel-errors.order2') : '' }} <b>{{ExWindow ? ExWindow.translator('panel-errors.do') : '' }}</b></h4>
                    </div>
                        ...
                        <div class="changeable fixed-right col-md-3 col-sm-4 col-xs-12">
                            ...
                            <div class="right-bottom ">
                                ...
                                <label class="radio-button">
                                    <span class="exp">{{ExWindow ? ExWindow.translator('panel-errors.normal_order') : '' }} </span> <br>
                                ...
                                <!--
                                <label class="radio-button">
                                    <span class="exp">{{ExWindow ? ExWindow.translator('panel-errors.urgent_order') : '' }} </span> <br>
