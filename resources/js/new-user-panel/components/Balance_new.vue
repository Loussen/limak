        ...
        <div class="row relative">
            <div class="balance-block col-md-5 col-sm-5 col-xs-12">
                <div class="balance">
                    ...
                    <div class="balance-count">
                        ...
                        <br>
                        <span class="count">{{balance}} <sup>M</sup></span>
                    </div>
            ...
            <div class="col-md-7 col-sm-7 col-xs-12 right-side">
                <div class="right-top block">
                    <h4>{{ExWindow ? ExWindow.translator('panel-errors.increase_for_payment'): ''}}</h4>
                    <form method="POST"  action="/user-panel/increase-balance" id="balancePayment">
                        <div class="input-group border-radius">
                            <label>
                                <input placeholder=" " required type="number" name="amount" class="form-control inputText">
                                <span>{{ExWindow ? ExWindow.translator('panel-errors.amount_cash'): ''}}</span>
                            </label>
                            <button type="button" class="border-btn btn-effect" @click="alert()">{{ExWindow ? ExWindow.translator('panel-errors.increase_balance'): ''}}</button>
                        </div>
                    </form>
                    <span class="range-count">{{ExWindow ? ExWindow.translator('panel-errors.balance_range'): ''}}</span>
                    <div class="card_logolist">
                        <img src="/front/new/img/millikart.png" alt=" millikart">
                        <img src="/front/new/img/visa-logo-master.png" alt=" visa">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-12">
                <div class="block">
                    <div class="col-md-10 col-sm-9 col-xs-9">
                        ...
                        <p>
                            {{ExWindow ? ExWindow.translator('panel-errors.milli_on_text'): ''}}
                            <br><br>
                            {{ExWindow ? ExWindow.translator('panel-errors.milli_on_description'): ''}}
                        </p>
                    </div>
                    <div class="col-md-2 col-sm-3 col-xs-3">
                        <img src="/front/new/img/terminal.png" alt="terminal" class="img-responsive center-block">
                    </div>
                </div>
            </div>
        </div>
...
<script>
  ...
  export default {
        ...
        methods: {
            ...
            getLogBalance() {
                console.log('test')
                var path = '/user-panel/get-log-balance?type=' + this.filter_type.id + '&balance_type=azn';
