    ...
    <section class="page-block sifarish-et sifarisle-gorey">
        <div class="container">
            <div class="page-head">
                ...
                <h1>{{lang ? lang('link-order.order') : ''}}2</h1>
            ...
            submit() {
                ...
                if (valid) {
                    ...
                    swal({
                        ...
                        onOpen: () => {
                            swal.showLoading();
                            axios({url: api.orderLinkInsert2, method: 'POST', data: {data: this.orders,promo_code: this.promo, ytl: ytlPayment, total: this.exchange, deliveryType: this.deliveryType, country: this.country}}).then(response => {
                                swal.close();
