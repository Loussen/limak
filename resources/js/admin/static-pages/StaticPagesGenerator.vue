    ...
    <div class="container" v-if="sections">
        ...
        <ul class="nav nav-pills pb-4 pt-3">
            <li role="presentation" class="btn btn-outline-primary">
                <router-link v-bind:to="'/staticPage/' + id"><strong style="color: #03a9f4"> Ümumi</strong></router-link>
            </li>
            <li role="presentation" class="active btn btn-outline-primary">
                <router-link v-bind:to="'/staticPage/' + id + '/generator'"><strong style="color: white">Generator</strong></router-link>
            </li>
        </ul>
        <div class="row">
            <div class="col-12">
                <ul class="list-group pr-0">
                    <li class="list-group-item" v-for="section in sections">
                        <template v-if="section.type === 'text'">
                            <ctext v-bind:sec="section"></ctext>
                        </template>
...
<style>
    ...
    input[type="text"],.btn.btn-success,.nav-item a
    {
        font-size:18px;
    }
