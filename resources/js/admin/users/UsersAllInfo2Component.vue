                    ...
                    <div class="tab-list col-md-12 col-sm-12">
                        <ul class="nav nav-tabs" role="tablist">
                           ...
                           <!-- <li role="presentation"><a  href="javascript:void(0)" class="block" aria-controls="baglama" role="tab"
                            ...
                            <li role="presentation"><a  href="javascript:void(0)" class="block" aria-controls="reject" role="tab"
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr v-for="item in balanceInfo">
                                    <td>{{splitMessage(item.message)}}</td>
            ...
            getAllInfo(id){
                ...
                axios.get('/cp/users/getUser',{params:{id:id}})
                    .then((response) => {
                        ...
                        this.counts.last30day_delivery_price = allData.last30day_delivery_price;
                        this.counts.last30day_payment = allData.last30day_payment;
