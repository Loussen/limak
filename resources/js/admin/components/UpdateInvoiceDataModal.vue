                ...
                <div v-if="productData">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" v-model="formData.orderTrackingNumber = productData.order_tracking_number" placeholder="Misal: 145678"/>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Sifarişin tarixi</label>
                            <input type="text" class="form-control" v-model="formData.orderDate = productData.order_date"/>
                        </div>
