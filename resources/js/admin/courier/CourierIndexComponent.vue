    ...
    <div v-if="this.roles.length >0">
        ...
        <div class="tab-content courier">
                ...
                <div class="block table-block">
                    ...
                    <table  class="table table-striped">
                        ...
                        <tr v-for="order of data">
                            ...
                            <td>
                                <a class="btn-effect" target="_blank" :href="'/cp/courier/act/'+order.c_id">AKT</a>
                            </td>
            ...
            <div role="tabpane2" class="tab-pane" id="delivered">
                <div class="block table-block">
                    <div v-if="delivered == null" class="loading"></div>
                    <!--<div  class="empty-content"><p class="text-center" style="font-size: 18px;font-weight: bold;">Məlumat yoxdur</p></div>-->
                    <table  class="table table-striped">
                        <thead>
                        <tr v-bind="count_i=0">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getCourierOrders() {
                axios.get('/admin/courier/orders-waiting?status=4&has_courier=0')
                    .then(data => {
