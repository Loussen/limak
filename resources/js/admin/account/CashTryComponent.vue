            ...
            <div v-if="show_outlay" class="modal fade outlay" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input v-model="receipt" class="form-control" placeholder="Məbləği daxil et AZN">
                            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            storeTry(type) {
                axios.post('/cp/cash/storeTry', {money: this.receiptTry, type: type})
                    .then((response) => {
                        this.getCashBalance();
                        this.show_outlay = false;
            ...
            addBalanceTry(type) {
                ...
                axios.post('/cp/cash/handleUserBalanceTry', data)
                    .then((response) => {
                        swal({
                            title: 'Balans redaktə olundu',
