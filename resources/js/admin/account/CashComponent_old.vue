            ...
            <div class="right-side cash col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="block table-block">
                    <table class="table table-striped">
                        ...
                        <tr v-for="product in user.stock" v-if="!(product.status_id==7 && product.is_paid==1 && product.courier.is_paid==1)">
                            ...
                            <td v-if="product.courier!=null && product.courier.is_paid==1">Kuryer ödəndi</td>
                            <td v-else-if="product.courier!=null && product.courier.is_paid==0">Kuryer ödənmədi</td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td>Anbarda saxlama məbləği</td>
                                    <td>{{ user_payment.depot_price}}</td>
                                </tr>
            ...
            <div class="col-xs-12" style="opacity: 0" id="check" >
                ...
                <table style="margin-bottom: 15px">
                    ...
                    <tr>
                        ...
                        <td>
                            {{ date.getDate() }}/{{ parseInt(date.getMonth())+1 }}/{{ date.getFullYear() }} {{ date.getHours() }}:{{ date.getMinutes() }}
                        </td>
                    </tr>
                </table>
            </div>
    ...
    export default {
        ...
        methods: {
            setCourierPayment(){
                ...
                this.user_payment.total_price = parseFloat(this.user_payment.shipping_price) + courier_payment;
            ...
            openPaymentModel(){
                ...
                for(let i in this.user.stock){
                    if(this.user.stock[i].selected){
                        ...
                        this.depot_numbers += (this.user.stock[i].depot_invoice)? this.user.stock[i].depot_invoice.depot.barcode_id +" " : '';
                    }
                }
