            ...
            <div class="col-12 mt-3">
                <table class="table table-hovered table-stripped bg-white">
                    ...
                    <tr>
                        ...
                        <th>Balans</th>
                        <th>Bağlama</th>
                        <th>Çatdırılma pulu (AZN)</th>
                        <th>Ödəniləcək məbləğ (AZN)</th>
                        <th></th>
                    </tr>
                    </thead>
                    <tbody>
                    <template v-if="list && list.length > 0">
                        <tr v-for="(product, index) of list">
                            ...
                            <td>
                                {{ payable(product.delivery_price, product.rel_user_products.users.balance) }} AZN
                            </td>
                            <td>
                                <button v-if="!product.is_paid" class="btn btn-success" @click="pay(product)">Ödə</button>
                                <button v-if="product.is_paid" class="btn btn-info">Ödənilib</button>
                            </td>
                        </tr>
                    </template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            payable(delivery_price, user_balance){
                let price = delivery_price * 1.7;
                if(user_balance < 0) price -= user_balance;
