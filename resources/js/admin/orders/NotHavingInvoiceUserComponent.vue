    ...
    <div class="row" v-if="this.roles.length >0">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="top-menu">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><router-link to="/orders/noinvoice">İnvoys olmayanlar</router-link></li>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="block customer-list">
                <ul v-if="data.products.users" class="list-user">
                    <li>Ad, Soyad <p v-if="data.products.users">{{data.products.users.name}} {{data.products.users.surname}}</p></li>
                    <li>E-mail <p v-if="data.products.users">{{data.products.users.email}}</p></li>
                    <li>Mobil telefon <p v-if="data.products.users.user_contacts">
                        <span style="display: block; margin-bottom: 10px;" v-for="userContact of data.users.user_contacts">
                            {{userContact.name}}
                        </span>
                    </p></li>
                    <li v-if="data.products.users">Ünvan <span class="red">Məhsulu alan zaman ünvanı kopyalamağı unutmayın!</span>
                        <p>
                            Halkalı Merkez Mahellesi. Üzümlü SK. 5/7 kod: {{data.products.users.uniqid}} {{data.products.users.name}} {{data.products.users.surname}} <button style="margin-left: 10px;" class="btn btn-xs btn-primary" @click.stop.prevent="copyTestingCode">Kopyala</button>
                            <input type="hidden" id="copy" :value="'Halkalı Merkez Mahellesi. Üzümlü SK. 5/7 kod: ' + data.products.users.uniqid + ' ' + data.products.users.name + ' ' + data.products.users.surname">
                        </p>
                    </li>
                </ul>
            </div>
            ...
            <div class="block table-block">
                <table class="table table-responsive table-striped">
                    ...
                    <tr >
                        ...
                        <td>{{ ((parseInt(data.products.price) + nullToZero(data.shipping_price))*1.05).toFixed(2)  }} TL</td>
                        <td>{{ parseInt(data.products.price) + nullToZero(data.shipping_price) }} TL</td>
                        <td>{{ nullToZero(data.shipping_price) }} TL</td>
                        <td>{{ 4 }} TL</td>
                        <td>{{ data.products.shop_name }}</td>
                        <td>{{ data.products.quantity }}</td>
                        <td></td>
                        <td style="max-width: 200px">{{ data.products.description }}</td>
                        <td class="upload-but count-end">
                            <a href="#" @click.prevent="showInvoice()" class="btn-effect lite-green">Bəyənnaməyə bax</a><br>
                        ...
                        <td>
                            <button type="button" class="btn-effect edit">Dəyiş</button><br>
                            <button type="button" class="btn-effect yellow">Dəyiş</button>
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <!--<div style="width: 100%;" class="container">-->
            <!--<section class="paper-card">-->
                    ...
                    <!--<div class="col-lg-12">-->
                        ...
                        <!--<table class="table dtr-details" width="100%" v-if="data != null && data.length != 0">-->
                            ...
                            <!--<tr v-for="product in data.products">-->
                                ...
                                <!--&lt;!&ndash;<td>{{product.extras.countries.translates[0].name}}</td>&ndash;&gt;-->
                                ...
                                <!--<td>-->
                                    <!--&lt;!&ndash; <div v-if="!(product.statuses.label === 'rejection' || product.statuses.label === 'rejection_accepted') && product.invoices[0] && product.invoices[0].file === null">&ndash;&gt;-->
                                    <!--<div>-->
                                        <!--<div v-if="product.statuses && product.statuses.label && (!(product.statuses.label === 'rejection' || product.statuses.label === 'rejection_accepted') && product.invoices[0] && product.invoices[0].file === null)">-->
                                    ...
                                    <!--<span v-if="product.statuses && product.statuses.label && (product.statuses.label === 'rejection' || product.statuses.label === 'rejection_accepted')">-->
                                        <!--Çatışmazlıq qeyd etmisiniz-->
                                    <!--</span>-->

                                    <!--&lt;!&ndash;<div v-if="product.invoices[0] && product.invoices[0].file !== null">-->
                                        <!--<button class="btn btn-outline-primary" v-on:click="showFile(product.invoices[0].file)">-->
                                            <!--<i class="icon-eye3"></i>-->
                                            <!--<span>bax</span>-->
                                        <!--</button>-->
                ...
                <!--</div>-->
            <!--</section>-->
            <!--<div v-if="data.statuses && data.statuses.label && (data !== null && data.statuses.label !== 'completed')" style="margin-top: 20px;" class="text-right">-->
