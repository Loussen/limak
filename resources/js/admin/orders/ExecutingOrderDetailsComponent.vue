    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="block customer-list">
                <ul class="list-user">
                    <li>sss{{user.products.clients}}</li>
                    ...
                    <li>Ünvan <span class="red">Məhsulu alan zaman ünvanı kopyalamağı unutmayın!</span>
                        <p>Halkalı Merkez Mahellesi. Üzümlü SK. 5/7 {{ user.uniqid }} {{ user.name }} {{ user.surname }} </p></li>
        ...
        <div class="col-md-2 col-sm-3 col-xs-12">
            <div class="balance block">
                <p class="btn-effect">Balans <span>{{ user.balance }}</span></p>
            ...
            <div class="block table-block">
                <table class="table table-responsive table-striped">
                    ...
                    <tr v-for="product in user.products">
                        ...
                        <td>{{(product.price * 1.05).toFixed(2)}} TL</td>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            getOrderDetails() {
                axios.get(`/cp/getOrderDetailByUser/${this.$route.params.id}`)
                    .then((response) => {
