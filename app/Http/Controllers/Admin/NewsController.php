...
class NewsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.news.index', compact('data', 'params'));
    }
    ...
    public function create()
    {
        ...
        $imagesUrl = [];
        $imagesConfig = [];
        return view('admin.news.form', compact('data', 'imagesUrl', 'imagesConfig'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.news.form', compact('data', 'id', 'imagesUrl', 'imagesConfig', 'url'));
    }
