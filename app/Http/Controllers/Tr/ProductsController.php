...
class ProductsController extends Controller
{
    ...
    public function invoiceUpload(Request $request) {
        ...
        if ($model->save()) {
            ...
            return response()->json(['status' => 500, 'message' => 'Server Xətası']);
        }
...
//        die;
    ...
    public function printHawb_old($productId) {
        ...
        return view('admin.invoice.pdf', compact( 'product', 'barcode', 'purchaseNo'));
    }
    ...
    public function printHawb($productId) {
        ...
        $depo_date = '';
        $invoice_date = InvoiceDates::where("invoice_id",$invoice->id)->where("status_id",2)->first();
        if($invoice_date!=null){
            $depo_date = $invoice_date->action_date;
        }
        ...
        $purchaseNo = rtrim($purchaseNo,' - ');
        return view('admin.invoice.pdf', compact( 'product', 'barcode', 'purchaseNo', 'invoice','regions','user','depo_date'));
    }
}
