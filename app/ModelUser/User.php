...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany('App\ModelProduct\Product', 'user_id')->where('status_id', '=', 1)->where('region_id', '=', self::$region_id)->where('client_id', '=', self::$client_id)->where('is_paid',1)->where('is_ordered','=',0);
    }
